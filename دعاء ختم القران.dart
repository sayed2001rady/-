...
class khatm_elkoran extends StatefulWidget {
  const khatm_elkoran({Key? key}) : super(key: key);

  @override
  _khatm_elkoranState createState() => _khatm_elkoranState();
}

class _khatm_elkoranState extends State<khatm_elkoran> {
  @override
...
رَبَّنَا آتِنَا فِي الدُّنْيَا حَسَنَةً وَفِي الآخِرَةِ حَسَنَةً وَقِنَا عَذَابَ النَّارِ وَصَلَّى اللهُ عَلَى سَيِّدِنَا وَنَبِيِّنَا مُحَمَّدٍ وَعَلَى آلِهِ وَأَصْحَابِهِ الأَخْيَارِ وَسَلَّمَ تَسْلِيمًا كَثِيراً.
          ...
          """, 1, "https://www.youtube.com/watch?v=kbZec0VqSCQ"),
        ],
      ),
    );
  }
