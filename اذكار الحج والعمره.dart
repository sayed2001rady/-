...
class azkar_elhagweelomra extends StatefulWidget {
  const azkar_elhagweelomra({Key? key}) : super(key: key);

  @override
  _azkar_elhagweelomraState createState() => _azkar_elhagweelomraState();
}

class _azkar_elhagweelomraState extends State<azkar_elhagweelomra> {
  @override
...
وهكذا يتجلى شأن الذكر في الحج، ويستبين عظم منزلته ورفيع مكانته. وفيما يلي الأدعية النبوية والأذكار الواردة في محطات الحج ومواقيته الزمانية والمكانية والعمرة والزيارة فاحفظها ليكون حجك مبرورا وسعيك مشكورا.
          """, 1, "https://www.youtube.com/watch?v=VnKcdBCPfzM"),
          azkar_card("""
الذكر عند الاحرام
