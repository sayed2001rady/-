...
class ad3ayat_elanbya extends StatefulWidget {
  const ad3ayat_elanbya({Key? key}) : super(key: key);

  @override
  _ad3ayat_elanbyaState createState() => _ad3ayat_elanbyaState();
}

class _ad3ayat_elanbyaState extends State<ad3ayat_elanbya> {
  @override
    ...
    return Container(
      ...
      child: ListView(
        children: [
          ...
          """, 1, "https://www.youtube.com/watch?v=opFFOIHUPok"),
          azkar_card("""
...
"رَبِّ هَبْ لِي مِنَ الصَّالِحِينَ
          ...
          """, 1, "https://www.youtube.com/watch?v=opFFOIHUPok"),
          azkar_card("""
           إِنِّي ظَلَمْتُ نَفْسِي فَاغْفِرْ لِي". [القصص - 16].
...
"رَبِّ اشْرَحْ لِي صَدْرِي (25) وَيَسِّرْ لِي أَمْرِي (26) وَاحْلُلْ عُقْدَةً مِّن لِّسَانِي (27) يَفْقَهُوا قَوْلِي
          """, 1, "https://www.youtube.com/watch?v=opFFOIHUPok"),
          azkar_card("""
