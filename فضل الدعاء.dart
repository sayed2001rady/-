...
class fadl_eldo3a extends StatefulWidget {
  const fadl_eldo3a({Key? key}) : super(key: key);

  @override
  _fadl_eldo3aState createState() => _fadl_eldo3aState();
}

class _fadl_eldo3aState extends State<fadl_eldo3a> {
  @override
...
قال صَلَّى اللَّهُ عَلَيْهِ وَسَلَّمَ: " مَا مِنْ عَبْدٍ مُسْلِمٍ يَدْعُو لِأَخِيهِ بِظَهْرِ الْغَيْبِ إِلَّا قَالَ الْمَلَكُ : وَلَكَ بِمِثْلٍ". [رواه مسلم]
          """, 1, "https://www.youtube.com/watch?v=qOlBD93c5SM")
        ],
      )
    );
  }
