...
class azkar_elazan extends StatefulWidget {
  const azkar_elazan({Key? key}) : super(key: key);

  @override
  _azkar_elazanState createState() => _azkar_elazanState();
}

class _azkar_elazanState extends State<azkar_elazan> {
  @override
    ...
    return Container(
      ...
      child: ListView(
        children: [
          ...
          """, 1, "https://www.youtube.com/watch?v=dO9lh4OlgLs"),
          azkar_card("""
