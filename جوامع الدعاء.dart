...
class gwama3_eldo3a extends StatefulWidget {
  const gwama3_eldo3a({Key? key}) : super(key: key);

  @override
  _gwama3_eldo3aState createState() => _gwama3_eldo3aState();
}

class _gwama3_eldo3aState extends State<gwama3_eldo3a> {
  @override
...
اللَّهُمَّ رَبِّ اغْفِرْ لِي وَلِوَالِدَيَّ وَلِمَنْ دَخَلَ بَيْتِيَ مُؤْمِنًا وَلِلْمُؤْمِنِينَ وَالمُؤْمِنَاتِ.""", 1, "https://www.youtube.com/watch?v=dyDq-eL1_Ns"),
          azkar_card("""
...
اللَّهُمَّ يَا مَنْ لا تَضُرُّهُ الذُّنُوبُ ، وَلا تُنْقِصُهُ المَغْفِرَةُ ، اغْفِرْ لَنَا مَا لا يَضُرُّكَ ، وَهَبْ لَنَا مَالا يُنْقِصُكَ.
          """, 1, "https://www.youtube.com/watch?v=dyDq-eL1_Ns"),
          azkar_card("""
