...
class ad3ayat_elmayet extends StatefulWidget {
  const ad3ayat_elmayet({Key? key}) : super(key: key);

  @override
  _ad3ayat_elmayetState createState() => _ad3ayat_elmayetState();
}

class _ad3ayat_elmayetState extends State<ad3ayat_elmayet> {
  @override
...
اللَّهُمَّ صلّ وسلّم وبارك على سيّدنا محمّد، وعلى اّله وصحبه وسلّم إلى يوم الدّين.
          ...
          """, 1, "https://www.youtube.com/watch?v=NRsm1iuobME"),
            azkar_card("""
